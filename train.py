...
def main(args):
    ...
    for epoch in range(start_epoch, epochs):
        for phase in phases: #['train', 'val'] or ['train']
            ...
            for i, (x, y, csm, mask) in enumerate(dataloaders[phase]):  #enumerate(islice(dataloaders[phase], 100)):  
            ...
            #epoch_score = {score_name: score / 100 for score_name, score in running_score.items()}
            ...
            if args.write_lambda:
                ...
                #writers['train'].add_scalar('eigenvalue', model.dc.max_eig, epoch)
